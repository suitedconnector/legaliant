        ...
        <div className="bg-white rounded-2xl shadow-card border border-gray-100 overflow-hidden">
          <div className="bg-navy px-6 pt-5 pb-3">
            ...
            <p className="text-white/35 text-xs">
              California jurisdiction · {claimCount} claim{claimCount !== 1 ? 's' : ''} · {evidenceScore}/3 evidence factors
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-card border border-gray-100 p-6">
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={3}
                placeholder="Briefly describe what happened — why you believe you were wrongfully terminated, any patterns of discrimination or retaliation, etc."
          ...
          <button
            ...
            className={[
              ...
              unlocking ? 'opacity-75 cursor-not-allowed' : 'hover:-translate-y-0.5',
            ].join(' ')}
            style={{
              background: unlocked
          ...
          >
            {unlocked ? (
              <><Unlock size={18} strokeWidth={2.5} /> Unlocking Your Analysis…</>
            ) : unlocking ? (
              <><div className="w-4 h-4 border-2 border-navy/30 border-t-navy rounded-full animate-spin" /> Unlocking…</>
            ) : (
              <><Lock size={18} strokeWidth={2} /> Unlock My Case Analysis</>
            )}
          </button>
