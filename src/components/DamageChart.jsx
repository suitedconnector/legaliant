...
export default function DamageChart({ damageCategories }) {
  ...
  // Parse estimated ranges and calculate midpoints
  const chartData = damageCategories
    .filter(cat => cat.estimatedRange && cat.estimatedRange !== 'N/A')
    .map(cat => {
      // Parse range like "$50,000 - $100,000" to get midpoint
...
function getCategoryColor(category) {
  const colors = {
    'Back Pay': '#3b82f6',      // Blue
    'Front Pay': '#10b981',     // Green
    'Emotional Distress': '#f59e0b', // Amber
    'Punitive Damages': '#ef4444',   // Red
    'Attorney Fees': '#8b5cf6',      // Purple
  };
